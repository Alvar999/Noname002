...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"PED","Seat_talk_01", 4.0, 1, 0, 0, 0, 0);
    return 1;
}
CMD:ngoighe(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "MISC", "SEAT_LR", 4.0, 1, 0, 0, 0, 0, 1);
	case 2: PlayAnimEx(playerid, "PED", "SEAT_idle", 4.0, 1, 0, 0, 0, 0, 1);
	case 3: PlayAnimEx(playerid, "MISC", "Seat_talk_01", 4.0, 1, 0, 0, 0, 0, 1);
	case 4: PlayAnimEx(playerid, "MISC", "SEAT_watch", 4.0, 1, 0, 0, 0, 0, 1);
	default: SendClientMessage(playerid, COLOR_WHITE, "USAGE: /ngoighe [1-4]");
	}
	return 1;
}
